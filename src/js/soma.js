    ...
    _parseChannels(channels) {
        ...
        if (Array.isArray(channels)) {
            for (let c of channels) {
                ...
                if (c.id == 'sunshinelivetechno') {
                  c.mp3file = 'https://stream.sunshine-live.de/techno/mp3-192/stream.sunshine-live.de/';
                }
                c.songsurl = 'https://somafm.com/songs/groovesalad.json';
                c.infourl = c.description;
